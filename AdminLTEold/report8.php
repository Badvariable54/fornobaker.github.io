...
<div class="wrapper">
  <?php
    ...
    $qold = $d->select("orders,order_detail,baker,customer,product,deliveryboy","orders.db_id=deliveryboy.db_id and orders.cu_id=customer.cu_id and product.p_id=order_detail.p_id and orders.o_id=order_detail.o_id and orders.b_id=baker.b_id and orders.b_id='$bid' and orders.o_total>='$ototal'","");
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1><?php echo "Selected baker "."<b>".$bakername."</b>"." order total greater than "."<b>".$ototal."</b>"." orders list"; ?></h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <table id="example1" class="table table-bordered table-striped table-hover">
                ...
                $i=1;
                $que = $d->count_data("'p_id'","product,order_detail","product.p_id=order_detail.p_id");
                ...
                while($data = mysqli_fetch_array($q))
                {
                  ...
                  <tr>
                    ...
                    <td value="<?php echo $data['p_id']; ?>">
                      <?php echo $data['p_name']; ?></td>
                    <td><?php echo $data['p_price']; ?></td>
                    <td><?php echo $data['od_qty']; ?></td>
