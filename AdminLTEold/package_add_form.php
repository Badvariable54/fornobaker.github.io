            ...
            <div class="card card-primary">
              ...
              <form role="form" action="controller.php" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="row">
                    <div class="col-sm-8">
                      ...
                      <div class="inputclass">
                        <input type="text" name="rg_name" required>
                  ...
                  <div class="row">
                    <div class="col-sm-8">
                      ...
                      <div class="form-group">
                      <div class="inputclass">
                        <input type="text" name="rg_duration" required>
                  ...
                  <div class="row">
                    <div class="col-sm-8">
                      ...
                      <div class="form-group">
                      <div class="inputclass">
                        <input type="text" name="rg_price" required>
                ...
                <div class="card-footer">
                  <div class="middle">
                  <button type="submit" class="btn btn1" name="rg_add">Submit</button>
                </div></div>
                                <div><pre>                </pre></div>
