...
<div class="login-wrap">
	<div class="login-html">
		...
		<div class="login-form">
			<div class="sign-in-htm">
				<div class="group">
					...
					<input id="user" type="text" class="input" name="l_email" required>
				</div>
				<div class="group">
				...
				<br/>
				<div class="group">
					<input type="submit" class="button" value="Sign In" name="l_btn">
				</div>
				<div class="hr"></div>
      ...
      <form action="forgotpass.php" method="post"> 
        <p class="mb-1">
         <center> <a href="forgotpass.php">I forgot my password </a></center>
