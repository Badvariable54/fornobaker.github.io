          ...
          <div class="col-md-10">
            ...
            <div class="card card-primary">
              ...
              <?php
                    $db_id=$_POST['db_id'];
                    $i=1;
                    $q = $d->select("deliveryboy","db_id='$db_id'","");
              ...
              <form role="form" action="controller.php" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="row">
                    <div class="col-sm-8">
                      ...
                      <div class="inputclass">
                        ...
                        <input type="text" name="db_fname" value="<?php echo $data['db_fname']; ?>" required>
                  ...
                  <div class="row">
                    <div class="col-sm-8">
                      ...
                      <div class="form-group">
                      <div class="inputclass">
                        <input type="text" name="db_lname" value="<?php echo $data['db_lname']; ?>" required>
                  ...
                  <div class="row">
                    <div class="col-sm-8">
                      <div class="form-group">
                       <div class="inputclass"> 
                        <input type="text" name="db_phone" value="<?php echo $data['db_phone']; ?>" required>
                  ...
                  <div class="row">
                    <div class="col-sm-8">
                      <div class="form-group">
                       <div class="inputclass">
                        <input type="email"  id="exampleInputEmail1"  name="db_email" value="<?php echo $data['db_email']; ?>" required>
                    ...
                    <div class="col-sm-8">
                      <div class="form-group">
                        ...
                        <!--<input type="text" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask required name="db_dob">-->
                          <input type="text" name="db_dob" value="<?php echo $data['db_dob']; ?>" required>
                          <label>DOB</label>
                        </div>
                      </div>
                    </div>  
                  ...
                  <div class="row">
                    <div class="col-sm-8">
                      <div class="form-group">
                       <div class="inputclass">
                        <input type="text"  name="db_gender" value="<?php echo $data['db_gender']; ?>" required >
                        <label>Gender</label>
                       </div>
                      </div>
                    </div>  
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary" name="db_update">Update</button>
                </div>
              </form>
              <?php } 
                ?>
