...
<div class="wrapper">
  <?php
    $rgid=$_POST['rg_id'];
    $i=1;
    $qold = $d->select("registration_package,baker","baker.rg_id = registration_package.rg_id and registration_package.rg_id='$rgid' ","");
    $dataold = mysqli_fetch_array($qold);
    $packname = $dataold['rg_name'];
      ?>
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1><?php echo "Selected package "."<b>".$packname."</b>"." baker list"; ?></h1>
          </div>
          <div class="col-sm-6">
          </div>
        </div>
